...
import { useAdmin } from "@/features/Auth/useAdmin"; // ✅ 관리자 여부
import { Switch } from "@/shared/ui/switch"; // ✅ 보기/편집 스위치
...
export default function FloatingMemo({ memoId = "memo" }: Props) {
  ...
  // ✅ 창 이탈(beforeunload) 경고: 전역 덮어쓰기 금지, addEventListener로 컴포넌트 단위 등록/해제
  useEffect(() => {
    if (!open) return;
